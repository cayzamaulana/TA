        ...
        private void CreateLocalizationTable(Type type)
        {
            ...
            foreach (object id in tableDataProvider)
            {
                ...
                if (hiddenByScroll)
                {
                    ...
                    EditorGUILayout.BeginHorizontal(GUILayout.MinWidth((Screen.width / 2) - indexColWidth - optionsColWidth - rowButtonsSize - languageColWidth ));
                    if (id is string)
                    {
                        EditorStyles.textField.wordWrap = true;
                        modifiedId = EditorGUILayout.TextArea((string)id, GUILayout.Height(stringTextFieldHeight), GUILayout.ExpandWidth(true), GUILayout.MaxWidth((Screen.width / 2) - indexColWidth - optionsColWidth - rowButtonsSize - languageColWidth));
                    }
